...
export class RequestHandler {
    ...
    async getRequest(statusCode: number, schemaOptions?: { dir: string, file: string }) {
        ...
        if (schemaOptions) {
            await validateSchema(schemaOptions.dir, schemaOptions.file, responseJSON);
        }

        return responseJSON
    }

    async postRequest(statusCode: number, schemaOptions?: { dir: string, file: string }) {
        const url = this.getUrl()
    ...
    async putRequest(statusCode: number, schemaOptions?: { dir: string, file: string }) {
        const url = this.getUrl()
    ...
    async deleteRequest(statusCode: number, schemaOptions?: { dir: string, file: string }) {
        const url = this.getUrl()
